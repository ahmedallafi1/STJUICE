...
for (const route of ["/menu", "/build", "/drops", "/boxes", "/catering", "/rewards", "/location", "/account", "/about", "/states"]) {
...
assert.ok(viewsSource.includes("Stage 06"), "Ordering-stage boundary must be visible");
