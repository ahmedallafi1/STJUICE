...
Implementation status: **Completed in this package.** This document is retained as the input contract; see `../ORDERING_SYSTEM_INDEX.md` and `../ordering/` for the delivered system.
