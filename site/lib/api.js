...
export const accountApi = {
  ...
  reorder: (orderId) => request(`../api/account/reorder/${encodeURIComponent(orderId)}`),
  updateProfile: (input, csrfToken) => request("../api/account/profile", { method: "PATCH", headers: { "X-CSRF-Token": csrfToken }, body: JSON.stringify(input) }),
  saveAddress: (input, csrfToken) => request("../api/account/addresses", { method: "POST", headers: { "X-CSRF-Token": csrfToken }, body: JSON.stringify(input) }),
  removeAddress: (id, csrfToken) => request(`../api/account/addresses/${encodeURIComponent(id)}`, { method: "DELETE", headers: { "X-CSRF-Token": csrfToken } }),
