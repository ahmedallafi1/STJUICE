...
for (const blocker of ["public_origin", "indexing", "live_payment", "live_pos", "tax", "database", "staff_auth", "operations_audit", "nutrition", "release_approval"]) assert.ok(result.blockers.includes(blocker), `${blocker} must remain blocked`);
