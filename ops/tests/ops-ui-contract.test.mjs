...
for (const marker of ["api(\"commercial\")", "data-product-state-form", "data-drop-state-form", "data-box-state-form", "commercial/products/", "commercial/drops/", "commercial/boxes/", "Recent staff actions", "Launch"]) {
